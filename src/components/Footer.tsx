    ...
    <footer className="border-t border-white/5 mt-20">
      <div className="max-w-6xl mx-auto px-6 py-12 flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <nav className="flex flex-wrap justify-center gap-6 text-sm text-parchment/50" style={{ fontFamily: 'var(--font-body)' }}>
          ...
          <Link href="/blog" className="hover:text-parchment/80 transition-colors">Writing</Link>
          ...
          <a href="https://www.infinitegameos.io" target="_blank" rel="noopener" className="hover:text-parchment/80 transition-colors">Infinite Game OS</a>
