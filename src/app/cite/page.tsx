...
const worksPapers: CitedWork[] = [
  {
    ...
    citation: {
      apa: 'Belone, L. (2026). The Infinite Game OS. A framework for sovereign creator practice in the AI era [Preprint]. SSRN. https://doi.org/10.2139/ssrn.6810541',
      chicago: 'Belone, Lane. "The Infinite Game OS. A Framework for Sovereign Creator Practice in the AI Era." SSRN, June 15, 2026. https://doi.org/10.2139/ssrn.6810541.',
      bibtex: `@misc{belone2026igos_ssrn,
  author       = {Belone, Lane},
  title        = {The Infinite Game {OS}. A Framework for Sovereign Creator Practice in the {AI} Era},
  year         = {2026},
  howpublished = {SSRN preprint},
  doi          = {10.2139/ssrn.6810541},
  url          = {https://ssrn.com/abstract=6810541}
}`,
    },
  },
